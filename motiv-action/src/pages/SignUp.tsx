            ...
            <div className="w-full relative">
              <div className="mt-3">
                ...
                focus:outline-none"
                          ...
                          <div className="absolute inset-y-0 top-5 right-0 pr-3 flex items-center text-sm leading-5">
                            {isEye ? (
                              <svg
                ...
                px-6 py-3 block shadow-xl hover:text-white hover:bg-black"
                    ...
                    <hr className="text-center mt-4"></hr>
                    <label className="block text-gray-500 font-bold my-4 text-center">
                      <Link
                        to={Routes.SignIn}
